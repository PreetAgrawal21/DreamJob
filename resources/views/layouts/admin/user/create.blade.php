								...
								<div class="tab-content">
									<div class="" id="settings">
										<form class="form-horizontal">
											...
											<div class="form-group row">
												<label for="inputName" class="col-sm-2 col-form-label">{{ __('lastName') }}</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="" name="lname" value="" pattern="^[a-zA-Z]+(?:\s+[a-zA-Z]+)*$" title="Enter characters only" placeholder="lastName"required>
												</div>
											</div>
											<div class="form-group row">
